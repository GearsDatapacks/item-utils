...
execute as @a[scores={item_utils.main_menu=1..}] run function item_utils:api/main_menu
...
scoreboard players enable @a item_utils.display_entity_config
execute as @a[scores={item_utils.display_entity_config=1..}] run function item_utils:api/display_entity_config
